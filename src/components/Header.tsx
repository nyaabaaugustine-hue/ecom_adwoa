        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="/" className="flex items-center gap-3 group flex-shrink-0">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-[9px] text-pink-400 uppercase tracking-[0.2em] font-semibold mt-0.5">
                Beauty &amp; Fashion
              </p>
            </div>
          </a>
          ...
          <div className="flex items-center gap-0.5">
            <button
              ...
              className="text-gray-500 hover:text-pink-500 transition-colors p-2.5 rounded-full hover:bg-pink-50"
              aria-label="Search"
            >
              {searchOpen ? <X size={20} /> : <Search size={20} />}
            </button>
            <button
              className="text-gray-500 hover:text-pink-500 transition-colors p-2.5 hidden sm:flex rounded-full hover:bg-pink-50"
              aria-label="Wishlist"
            >
              <Heart size={20} />
            </button>
            ...
            {isAuthenticated && user ? (
              <div className="relative group hidden sm:block">
                <button
                  ...
                  className="flex items-center gap-1.5 text-gray-600 hover:text-pink-500 transition-colors p-2 rounded-full hover:bg-pink-50"
                >
                ...
                <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none group-hover:pointer-events-auto">
                  ...
                  <button
                    onClick={onDashboardClick}
                    className="w-full flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-500 transition-colors"
                  >
            ...
            <button
              onClick={onCartClick}
              className="relative text-gray-500 hover:text-pink-500 transition-colors p-2.5 rounded-full hover:bg-pink-50"
        ...
        {searchOpen && (
          <div className="pb-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search for Ankara, Kente, Shea Butter, Skincare..."
            ...
            {categories.map((cat) => (
              <a
                ...
                className={`px-6 py-3.5 text-sm font-medium flex items-center justify-between ${
                  cat.highlight ? "text-pink-500 font-bold" : "text-gray-700 hover:text-pink-500 hover:bg-pink-50"
                } transition-colors`}
              ...
              {isAuthenticated && user ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-sm text-red-500 font-medium py-2"
                  >
                    <LogOut size={16} />
                    Sign Out
                  </button>
